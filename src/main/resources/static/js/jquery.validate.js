...
(function($){
	if ($.validator) {
        ...
        $.validator.addMethod("ococ", function(value, element) {
            return this.optional(element) || /^[a-zA-Z0-9]{8}-[a-zA-Z0-9]$/.test(value);
        }, "组织机构代码证格式有误");

        $.validator.addMethod("residence", function(value, element) {
            return this.optional(element) || /^[a-zA-Z]{3}\d{12}$/.test(value);
        }, "外国人永久居留证格式有误");

        $.validator.addMethod("policyNo", function(value, element) {
            return this.optional(element) || /^[a-zA-Z0-9]{4,25}$/.test(value);
        }, "保单号格式有误");
		...
		$.validator.addMethod("sscode", function(value, element) {   
		    var tel = /^[0-9]{6}$/;
		...
		$.validator.addMethod("issoliders", function(value, element) {   
		    var solider = /[\u4e00-\u9fa5](字第){1}(\d{4,8})(号?)$/;//简单的是/^[a-zA-Z0-9]{7,21}$/
		    return this.optional(element) || (solider.test(value));
		}, "军官证号格式错误");
		$.validator.addMethod("isregister", function(value, element) {   
		    var isregister = /^[a-zA-Z0-9]{3,21}$/;
		    return this.optional(element) || (isregister.test(value));
		}, "户口本格式错误");
		$.validator.addMethod("isHKMacao", function(value, element) {
			var re = /^[HMhm]{1}([0-9]{10}|[0-9]{8})$/;
			return this.optional(element) || (re.test(value));
		}, "港澳通行证格式不正确");
		$.validator.addMethod("isTaiwan", function(value, element) {
			var re1 = /^[0-9]{8}$/;
			var re2 = /^[0-9]{10}$/;
